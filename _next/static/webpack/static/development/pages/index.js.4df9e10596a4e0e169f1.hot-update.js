...
var Tip = _styledComponents["default"].div.withConfig({
  displayName: "pages__Tip",
  componentId: "lgvotk-2"
})(["display:flex;color:#fff;background:#000;align-items:center;padding:5px;position:absolute;", ""], function (_ref) {
  ...
  var position = {
    x: "".concat(radius * Math.cos(truedAngle) + 400, "px"),
    y: "".concat(radius * Math.sin(truedAngle) + 400, "px")
  };
  console.log(position);
  return (0, _styledComponents.css)(["bottom:", ";left:", ";"], position.y, position.x);
});
...
//# sourceMappingURL=index.js.4df9e10596a4e0e169f1.hot-update.js.map