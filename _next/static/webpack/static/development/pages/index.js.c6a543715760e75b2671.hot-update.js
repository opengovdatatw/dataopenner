...
})(["position:relative;margin:0 auto;width:100%;max-width:600px;flex:1;display:flex;flex-direction:row-reverse;align-items:flex-end;"]);

var Item = _styledComponents["default"].div.withConfig({
  displayName: "Rank__Item",
  componentId: "sc-1jps8v2-1"
})(["flex:1;background-color:rgba(255,255,255,0.6);margin:0 5px;height:", "%;transition-property:height;transition-duration:1s;"], function (_ref) {
  ...
  (0, _createClass2["default"])(Rank, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(Wrapper, (0, _extends2["default"])({}, props, {
        ...
        __self: this
      }), (0, _map2["default"])((0, _take2["default"])(results, 8), function (result) {
        return _react["default"].createElement(Item, {
          key: "".concat(replies[idx]).concat(result.name),
          ...
          __self: this
        }, result.name, _react["default"].createElement("span", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 68
          },
...
var _default = (_Rank = Rank, (0, _recompose.withPropsOnChange)(["data"], function (_ref2) {
  var data = _ref2.data;
  var results = {};
...
//# sourceMappingURL=index.js.c6a543715760e75b2671.hot-update.js.map